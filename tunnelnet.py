...
main.geometry("1470x960") ### TEMPORARILY USING MY GEOMETRY FOR TESTING PURPOSES
main.configure(bg="lightgray")
for i in range(10): # I have changed this to suit my code for now; we can change it later
...
# Images variables
bgimgdata = tk.PhotoImage(data=bgimgraw) # code for current file.
